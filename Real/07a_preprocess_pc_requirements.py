...
입력:
  - 02b_steam_appdetails_summary.csv   (pc_minimum, pc_recommended 컬럼)

출력:
  - 07a_pc_requirements.csv
      appid, hw_ram_gb, hw_storage_gb, hw_has_gpu_req, parse_success
  - 07a_parse_failures.csv
      파싱 실패(결측 대체된) 행 목록 — 검토용
...
OUT_CSV  = r"Real\07 preprocess\07a_pc_requirements.csv"
FAIL_CSV = r"Real\07 preprocess\07a_parse_failures.csv"
