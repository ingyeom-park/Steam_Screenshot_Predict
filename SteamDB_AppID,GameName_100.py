...
# 원하는 필터, 장르 등을 적용시켜 놓은 url을 넣어야 동작하는 구조.
# 본 코드에서는 "Games only", "≥ $1.00" 포함, "Adult Onlt" 배제, Followes 기준 descending orderby 적용.
target_url = "https://steamdb.info/tag/492/?category=-888&cc=us&displayOnly=Game&min_price=1&sort=followers_desc"
...
if status_code == 200:
	...
	df.to_csv('SteamDB_AppID,GameName_100.csv', index=False, encoding='utf-8-sig')
