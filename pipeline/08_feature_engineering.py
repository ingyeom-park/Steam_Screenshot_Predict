...
입력:
  ...
  - data/interim/06_image_features/06_image_features.csv
  - data/interim/07_preprocess/07a_pc_requirements.csv

출력:
  - data/processed/08_features/08_features_X.csv
  - data/processed/08_features/08_feature_columns.txt
...
APPDETAILS  = APPDETAILS_SUMMARY_CSV
USERTAGS    = USERTAGS_SUMMARY_CSV
TAGS_FINAL  = SELECTED_TAGS_CSV
IMG_FEATS   = IMAGE_FEATURES_CSV
HW_FEATS    = PC_REQUIREMENTS_CSV

OUT_X    = FEATURES_X_CSV
OUT_COLS = FEATURE_COLUMNS_TXT
