...
[출력 파일]
    data/interim/07_preprocess/07b_tfidf_features.csv
    data/interim/07_preprocess/07b_tfidf_vocabulary.txt
...
from project_paths import APPDETAILS_SUMMARY_CSV, TFIDF_FEATURES_CSV, TFIDF_VOCAB_TXT

IN_CSV   = APPDETAILS_SUMMARY_CSV
OUT_CSV  = TFIDF_FEATURES_CSV
OUT_VOC  = TFIDF_VOCAB_TXT
